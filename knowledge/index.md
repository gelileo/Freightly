...
| `app/router.py` (`onboard_customer`) + `POST /onboard-customer` | identity-model.md, api.md |
| `app/auth.py` (password: hash/verify/set/login_password) + `POST /auth/login`, `scripts/set_agent_password.py` | identity-model.md, api.md |
